...
public class Enums {
    ...
    public enum CastleSide {
        ...
        private CastleSide(int value) {
            if (value < 0  || value > 1) {
                // TODO: Change to InvalidEnumValueException later
                throw new RuntimeException("Attempt to create CastleSide object with invalid value: " + value);
            }
            this.value = value;
        }
    ...
    public enum EngineAlgorithm {
        ...
        private EngineAlgorithm(int value) {
            if (value < 0  || value > 4) {
                // TODO: Change to InvalidEnumValueException later
                throw new RuntimeException("Attempt to create EngineAlgorithm object with invalid value: " + value);
            }
            this.value = value;
        }
